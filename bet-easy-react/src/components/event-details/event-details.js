...
BetEasyDisplay = () => {
  return <div className="col-6 col-lg-2 col-2 col-md-2 border border-top-0 pt-2">
            { BetEasyLogo() }
         </div>
}

RacingDisplay = () => {
  return <div className=" col-4 col-lg-1 pt-3 px-4  border border-top-0 border-left-0">
            { Racing() }
...
SetBetIcon = (slug) => {
  switch (slug) {
    case 'mountaineer-park':
      return FilterHorseRacing();
    case 'horse-racing':
      return FilterHorseRacing()
    case 'greyhound-racing':
      return FilterDogRacing()
    case 'harness-racing':
      return FilterHarnessRacing()
    default:
      return;
  }
}
...
DisplayBets = (bets)  => {
   bets.map((bet) => { 
    const {EventType, EventName, Venue, AdvertisedStartTime } = bet;
    return (
     <div className="w-100 d-flex justify-content-between border border-left-0 border-right-0 border-top-0 m-1 pb-1">
       <div className="pt-1 col-2 col-lg-2 pl-0">
         { this.SetBetIcon(EventType.Slug) }
       </div> 
       ...
       <div className="col-4 col-lg-2 mx-0 pt-1 pt-lg-1 px-0">
         <span className="text-danger">
          <Moment fromNow ago>{ AdvertisedStartTime }</Moment>
         </span>
       </div>
    </div>
    )}
...
AllFilters = () =>
    <Fragment>
      <a href="/" className="button-theme theme-font-color col font-weight-bold m-1 p-0 pt-3 py-0 rounded"> All </a>
      <a href="/" className="button-theme col m-1 px-0 rounded"> { FilterHorseRacing() }</a>
      <a href="/" className="button-theme col m-1 px-0 rounded"> { FilterDogRacing() } </a>
      <a href="/" className="button-theme col m-1 px-0 rounded"> { FilterHarnessRacing() }</a>
    </Fragment>
...
export const getNextJump = async () => {
